    ...
    <div class="footer__container">
      <div class="footer__body">
        <a href="/" class="footer__logo-wrapper">
          <?php echo wp_get_attachment_image($logo, 'full', false, ['loading' => 'lazy', 'class' => 'footer__logo']); ?>
        </a>
              ...
              <?php foreach ($footer_contacts as $item): ?>
                <div class="footer__location-item">
                  ...
                  <div class="footer__location-item-info">
                    ...
                    <a href="<?php echo $item['phone_number']['url']; ?>"
                      class="footer__location-phone"><?php echo $item['phone_number']['title']; ?></a>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
